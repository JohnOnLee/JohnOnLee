...
summary: "옵시디언 볼트를 깃 저장소로 만들어 프라이빗 깃허브에 올리는 방법. .gitignore 설정, 동기화 루틴, 숫자 접두사 폴더 정렬까지 정리했습니다."
---
...
모바일은 사정이 조금 다릅니다. 이 플러그인은 모바일에서 isomorphic-git이라는 자바스크립트 구현체로 동작합니다. iOS와 안드로이드에서는 플러그인이 네이티브 git을 쓸 수 없기 때문입니다. 개발자도 README에서 모바일에는 제약이 많다고 직접 밝혀놨습니다. 그렇다고 포기할 일은 아닙니다. 저는 아이폰에서도 이 볼트를 쓰고 있습니다. 설정이 꽤 까다로운데, 한번 잡아두면 생각보다 잘 동작합니다. 그 세팅은 [아이폰 편](/guides/obsidian-git-iphone/)에 정리했습니다.
