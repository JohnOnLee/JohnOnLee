---
title: "에이전트 메모리 회고 (3): 완벽한 메모리는 유니콘이다"
date: 2026-08-14
tags: ["ai-memory", "coding-agents"]
summary: "부서진 것들을 치우면서 처음의 질문으로 돌아갔습니다. 메모리는 대체 왜 필요한가. 사과 그림, 때와 원칙, 그리고 주입됐는데도 행동이 바뀌지 않던 날들 끝에 도달한 결론, 유니콘입니다."
---
...
근데 행동이 달라지지 않습니다. 결과물도 바뀌지 않습니다. 예를 하나만 들겠습니다. 코딩이 끝나면 코덱스에게 PR 리뷰를 받아라, 받은 리뷰는 이렇게 처리하라. 규칙으로 만들어 뒀고, 코덱스 리뷰 진행을 지켜보는 모니터링 스크립트까지 있습니다. 그런데 이 절차를 처음부터 제대로 해낸 세션이 단 한 번도 없었습니다. 분명히 주입됐고, 보냈고, 읽혔습니다. 근데 안 바뀝니다. 에이전트를 향한 신뢰가 도리어 떨어져 갔고, 모델이 더 똑똑해질수록 이 경향은 더 강해질 겁니다.
