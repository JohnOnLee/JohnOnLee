...
summary: "Coding agents re-read the same files and re-ask the same questions every day. What memory does for an agent, how it differs from docs, and when it pays off."
---
