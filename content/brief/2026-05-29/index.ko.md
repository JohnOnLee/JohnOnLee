...
- 기업 AI 도입이 "도입 급증 → 예산 충격 → 재조정" 사이클에 진입 중. Uber의 AI 예산 조기 소진, Amazon의 리더보드 폐지는 초기 과잉 도입 후 교정 단계를 보여준다. AI ROI에 대한 냉정한 평가가 2026년 하반기 기업 시장의 주요 화두가 될 전망.

- AI 에이전트가 SaaS에 흡수되는 M&A 물결이 시작되었다(Asana-StackAI). 독립 AI 에이전트 스타트업들의 엑시트 경로가 "플랫폼 기업에 인수"로 수렴 중. 기존 SaaS 기업들이 에이전트 기능을 자체 통합하며 경쟁 구도가 재편될 조짐.
...
- 기업의 AI 토큰 비용을 추적·최적화하는 도구 시장이 열리고 있다. Uber 사례는 대기업도 AI 지출을 통제하지 못하고 있음을 보여준다. Claude Code/Codex 등의 사용량과 비용을 실시간 모니터링하고 최적화 제안을 주는 대시보드 = 명백한 페인 포인트. Tokenscope가 초기 형태를 보여주고 있지만, 기업용으로는 미개척.
